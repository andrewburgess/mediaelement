...
mejs.plugins = {
	silverlight: [
		{version: [3,0], types: ['video/mp4','video/m4v','video/mov','video/wmv','application/x-mpegURL','audio/wma','audio/m4a','audio/mp3','audio/wav','audio/mpeg']}
	],
	flash: [
		{version: [9,0,124], types: ['video/mp4','video/m4v','video/mov','video/flv','video/rtmp','video/x-flv','application/x-mpegURL','audio/flv','audio/x-flv','audio/mp3','audio/m4a','audio/mpeg', 'video/youtube', 'video/x-youtube']}
...
(function ($) {
	...
	mejs.MediaElementPlayer.prototype = {
		...
		meReady: function(media, domNode) {
			...
			if (!(mf.isAndroid && t.options.AndroidUseNativeControls) && !(mf.isiPad && t.options.iPadUseNativeControls) && !(mf.isiPhone && t.options.iPhoneUseNativeControls)) {
				...
				media.addEventListener('play', function() {
					...
					t.hasFocus = true;
					t.container.addClass('playing');
				},false);

				media.addEventListener('pause', function () {
					t.container.removeClass('playing');
				}, false);
		...
		setControlsSize: function() {
			...
			// dark space
			total.width(railWidth - (total.outerWidth(true) - total.width()) - 10);
